...
class OODGP(nn.Module):
    def __init__(self, envlr=1e-3, eistep=3, lambdae=0.5, use_kmeans=True,
    ...
    def fit(self, X, y):
        ...
        # env_w = self.env_w
        opti_env = optim.Adam([env_w], lr=0.01)
        ...
        for i in range(ei_step):
            ...
            try:
                ...
                # print(K_detach, K_detach.max(), K_detach.mean(), K_detach.min())
